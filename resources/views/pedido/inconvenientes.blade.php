...
@section('title', 'Inconvenientes')
@section('content_header')
    <h1>Pedidos inconvenientes</h1>
@stop
  ...
  <table class="table" style="width: 100%">
      ...
      @foreach($datos as $pedido)
        <tr>
            ...
            <a style="margin-bottom: 4px;border-top-width: 0px;" type="button" href="/pedidos/inconvenientes?id={{$pedido->id_pedido}}" class="btn btn-primary btn-sm">
              Cargar
            </a>
